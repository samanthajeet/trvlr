...
import EditQuill from "../EditQuill/EditQuill";
...
class EditPost extends Component {
  ...
  getPost = async () => {
    await axios
      .get(`/journal/${this.props.match.params.post_id}`)
      .then(response => {
  ...
  render() {
    return (
      <div>
        ...
        <div>
          <EditQuill 
            existing_text={this.state.post_text}
          />
          <p>entry</p>
          <input
            type="text"
        ...
        <img src={this.state.post_image1} alt={this.state.post_title} style={{"width": 400}} />
